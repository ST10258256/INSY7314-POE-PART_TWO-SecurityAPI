      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            <li className="nav-item"><NavLink className="nav-link" end to="/">List</NavLink></li>
            ...
            <li className="nav-item"><NavLink className="nav-link" to="/pay">Make Payment</NavLink></li>
          </ul>
        </div>
      </div>
    </nav>
